...
from keras.utils import img_to_array as image
...
def exp():
    ...
    face_haar_cascade = cv2.CascadeClassifier('haar_cascade_face_detection.xml')
    ...
    while True:
        ...
        for (x,y,w,h) in faces_detected:
            ...
            emotions = ['Surprise', 'Neutral', 'Anger', 'Happy', 'Anxiety']
